<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Address for: ') . $organisation->name }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('addresses.update', $address) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="building_name" class="block mt-1 w-full" type="text" name="building_name" 
                                :value="old('building_name', $address->building_name)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="street_name" class="block mt-1 w-full" type="text" name="street_name" 
                                :value="old('street_name', $address->street_name)" required />
                        ...
                        <div class="mb-6">
                            <label for="is_active" class="inline-flex items-center">
                                <input id="is_active" name="is_active" type="checkbox" 
                                    ...
                                    value="1" {{ old('is_active', $address->is_active) ? 'checked' : '' }}>
